package lld.lld1.Collection;
import java.util.*;

public class Client {
    public static void main(String[] args) {
        //        lld.lld1.Collection : Container , Group of OBjects
        // List , Set, Queue
//        lld.lld1.Collection

//        List : Ordered lld.lld1.Collection : insertion Order
        ...
        // random : O(1) : index
        // not lld.lld1.thread safe
        List<String> list1 = new ArrayList<>();

//        Doubly LL is used to implement this lld.lld1.Collection.
//        random : O(n)
